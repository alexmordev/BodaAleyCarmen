...
imágenes actuales en `public/images/` son **placeholders** (rectángulo
con etiqueta), no las fotos reales.

## Cómo reemplazarlas

Sustituye cada archivo por la foto definitiva usando **exactamente el mismo
nombre y extensión** — Next sirve `public/` desde la raíz y el sitio las
recoge por ruta absoluta (`/images/nombre.ext`), sin tocar `WeddingApp.jsx`.

| Sección                       | Archivo a reemplazar (en `public/images/`) |
|--------------------------------|-------------------------------------------------|
